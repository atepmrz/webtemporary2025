                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="javascript:void(0)" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">Marketing</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-2">
                        <h4 class="mb-2">Welcome to Marketing Panel! 👋</h4>
                        <p class="mb-4">Please sign-in to your account and start the adventure</p>

                        <form id="formAuthentication" class="mb-3" action="{{ url('/homePanel') }}" method="POST">
                            @csrf
