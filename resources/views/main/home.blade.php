    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <a href="{{ url("/promo-nugget") }}"><img src="{{ asset('img/banner/banner2.jpg') }}" class="d-block w-100"
                        alt="Image Slide"></a>
            </div>
            <div class="carousel-item">
                <a href="{{ url("/promo-hampers") }}"><img src="{{ asset('img/banner/banner3.jpg') }}" class="d-block w-100"
                        alt="Image Slide"></a>
            </div>
            @for ($x = 4; $x <= 5; $x++)
            <div class="carousel-item">
            ...
            <div class="col-lg-6">
                <div class="row gx-5 h-500">
                    ...
                    <div class="col-6 align-self-end wow fadeInDown" data-wow-delay="0.1s">
                        <img href="{{ url('/promo-jsm') }}" class="img-fluid border-3 border-primary"
                            style="border-radius: 10px" src="img/about-2.jpeg" onclick="openImageModal.show({
                                img: this,
                                animate: true
                            })" />
                    </div>
