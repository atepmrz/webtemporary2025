<head>
    ...
    <meta name="keywords"
        content="pt triputra karya lestari, pt harja gunatama lestari, prama borma group, prama borma toserba, borma group, prama Fresh, pramatoserba.co.id, Lebih Segar, Lebih Hemat, Lebih Dekat | Prama Toserba, Prama Borma supermarket, Prama Borma, lebih segar, resep masak sehat, lebih segar makanan, info hidup sehat, info sehat makanan, produk segar Penjualan, membeli segar, katalog promo hemat, makanan lezat, Sudah Murah Banyak Hadiahnya, prama online, Prama Borma Toserba,toserba bandung,
