        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Setetes darahmu bisa selamatkan nyawa! Yuk gabung jadi pahlawan kemanusiaan.
                    </p>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Temukan resep simple & lezat! Yuk, mulai petualangan memasak dengan kreasi
                        menarik yang sehat dan enak.</p>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Sensasi manis segar dengan promo Ice Cream Fair – jangan sampai ketinggalan!
                    </p>
                    <p class="text-muted">25/06/2025</p>
                </div>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Ubah gayamu! Warnai rambut gratis cukup belanja produk Sasha min. Rp 50.000 🎨
                    </p>
                    <p class="text-muted">25-06-2025</p>
                </div>
            </div>
